...
export default class WelcomePopup extends Popup {
  ...
  constructor() {
    ...
    this.header.append(el("h1", "Welcome to Thunder Dome!"));
    this.main.append(
      el(
        "p",
        "Discover a new way to engage with the hottest topics in the crypto world. At Thunder Dome, you can discuss, trade, and earn from the most talked-about subjects in the ecosystem.",
      ),
    );
    this.footer.append(
      new Button({
